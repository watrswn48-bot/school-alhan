...
export type ServantRole = 'admin' | 'senior_servant' | 'junior_servant';
...
export interface Lecture { id: string; title: string; speaker: string; speakerServantId?: string; levelName: AcademicLevel; yearName?: AcademicYear; schoolClass?: string; dateStr: string; timeStr: string; status: 'active' | 'elapsed'; isEvaluated?: boolean; evaluatedAt?: string; evaluatedBy?: string; evaluatedByName?: string; createdAt: string; createdBy: string; }
...
export interface CurriculumMaterial { id: string; title: string; subject: string; levelName: string; yearName?: string; schoolClass?: string; materialType: MaterialType; fileUrl?: string; fileData?: string; fileName?: string; fileSize?: string; contentNotes?: string; uploadedBy: string; uploadedById: string; createdAt: string; }
