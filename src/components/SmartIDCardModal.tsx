  ...
  return <div className="fixed inset-0 z-50 bg-slate-950/90 backdrop-blur-md p-3 sm:p-6 overflow-y-auto flex items-center justify-center">
    <div className="w-full max-w-xl bg-slate-900 border border-slate-700 rounded-3xl shadow-2xl p-4 sm:p-6 no-print">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-4 mb-5">
        <div><h3 className="font-black text-lg">كارنيه الطالب</h3><p className="text-xs text-slate-400">الوش والظهر جاهزين للطباعة</p></div>
      ...
      <div id="printable-id-cards" className="flex flex-col items-center gap-6">
        <div className="w-full max-w-[520px] aspect-[1.585/1] min-h-[320px] bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 border-2 border-amber-500/60 rounded-[28px] overflow-hidden relative shadow-2xl font-['Tajawal'] text-slate-100">
        ...
        <div className="w-full max-w-[520px] aspect-[1.585/1] min-h-[320px] bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 border-2 border-amber-500/60 rounded-[28px] overflow-hidden relative shadow-2xl font-['Tajawal'] flex items-center justify-center">
