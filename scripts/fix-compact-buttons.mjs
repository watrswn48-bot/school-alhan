...
// Remove demo credentials block from the login screen if present.
login = login.replace(
...
if (!cardButton.test(profile)) throw new Error('Profile ID card button not found');
